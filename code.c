...
int main(void) {
    ...
    *(pixel_ctrl_ptr + 1) = (int) &Buffer2;
	...
	// Player setup
    struct Player player1 = {xSize/2, ySize/2+15, xSize/2, ySize/2+15, 3, -10, 0, &wPressed, &sPressed, &aPressed, &dPressed, RED, 0, 0, pos1_16_bit_array};
    struct Player player2 = {xSize/2, 6, xSize/2, 6, 3, -10, 0, &upPressed, &downPressed, &leftPressed, &rightPressed, WHITE, 0, 0, pos1_16_bit_array};

	convert_to_2d(pos1_16_bit_array, pos1_8_bit_array, 16, 16);
	...
	while (1) {
		...
		while (1) {
			...
			// Players
			drawImage16Bit(player1.imageData, player1.x, player1.y, playerSize, playerSize);
